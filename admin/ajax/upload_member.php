...
if(isset($_POST['comName']))
{
    ...
    $phone = $_POST['phone'];
    $file = $_FILES['file'];
    $bond1 = upload_Profile($file,"../../img/member/");
    $query = "INSERT INTO member (`name`,`des`,`phone`,`image`) VALUES ('$comName','$des','$phone','$bond1')";
    if (mysqli_query($conn, $query))
    {
        echo "<span style='color:green'>New 'Member' Added successfully</span>";
    }
    else {
